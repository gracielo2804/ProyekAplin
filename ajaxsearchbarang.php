...
else
{
    ...
    {
        if($row['stok']>=$row['batas_bawah'])$keterangan='<span>Stok Aman</span>';
        else $keterangan='<span class=text-danger>Stok Perlu ditambah</span>';
        $strings=$strings."<tr>
        <td>$ctr</td>
        ...
        <td align=center><button type='submit'class='btn btn-warning' name='edit".$row['nama_barang']."' id='edit".$row['nama_barang']."' data-toggle='modal' data-target='#myEdit'>
            ...
            <button type='submit' class='btn btn-danger' name='del".$row['nama_barang']."' id='del".$row['nama_barang']."'>
